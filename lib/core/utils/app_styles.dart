...
class AppStyles {
  ...
  // Extra Small
  static TextStyle extraSmallText({Color? textColor}) =>
      GoogleFonts.outfit(fontSize: 10, color: textColor);

  static TextStyle extraSmallTextThin({Color? textColor}) => GoogleFonts.outfit(
    fontSize: 10,
    color: textColor,
  ...
  // Small
  static TextStyle smallText({Color? textColor}) =>
      GoogleFonts.outfit(fontSize: 12, color: textColor);
  ...
  static TextStyle smallRegularText({Color? textColor}) =>
      GoogleFonts.outfit(fontSize: 13, color: textColor);

  static TextStyle smallRegularTextBold({Color? textColor}) =>
      GoogleFonts.outfit(
        fontSize: 13,
        color: textColor,
        fontWeight: FontWeight.bold,
  ...
  // Regular
  static TextStyle regularText({Color? textColor}) =>
      GoogleFonts.outfit(fontSize: 14, color: textColor);
  ...
  // Medium
  static TextStyle mediumText({Color? textColor}) =>
  ...
  // Large
  static TextStyle largeText({Color? textColor}) =>
      GoogleFonts.outfit(fontSize: 18, color: textColor);
  ...
  // Extra Large
  static TextStyle extraLargeText({Color? textColor}) =>
      GoogleFonts.outfit(fontSize: 20, color: textColor);
  ...
  static TextStyle headlineText({Color? textColor, bool isMobile = false}) =>
      GoogleFonts.outfit(fontSize: isMobile ? 30 : 40, color: textColor);
  ...
  static TextStyle subText({Color? textColor, bool isMobile = false}) =>
      GoogleFonts.outfit(fontSize: isMobile ? 14 : 16, color: textColor);

  // Legacy support
  static TextStyle get s52 =>
      GoogleFonts.outfit(fontSize: 52, fontWeight: FontWeight.w600);
  ...
  static TextStyle get s24 =>
      GoogleFonts.outfit(fontSize: 24, fontWeight: FontWeight.w600);

  static TextStyle get s18 =>
      GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.w500);

  static TextStyle get s17 =>
      GoogleFonts.outfit(fontSize: 17, fontWeight: FontWeight.w500);

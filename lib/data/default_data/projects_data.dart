  ...
  static List<Project> getProjects() {
    return const [
      ...
      Project(
        ...
        imageUrl: 'https://raw.githubusercontent.com/vishnu32510/flashlight_control_flutter/main/assets/marketing/app_icon_512.png',
        description: 'Cross-platform Flutter flashlight app with feature-first architecture (Bloc, go_router, get_it). Store pipelines: GitHub Actions for Android (Play Console internal/production via Fastlane) and iOS via Xcode Cloud with Fastlane match; optional iOS lanes on GitHub Actions for TestFlight and App Store submit.',
        techStack: [
          'Flutter',
          'Dart',
          'Bloc',
      ...
      Project(
        ...
        imageUrl: 'https://raw.githubusercontent.com/vishnu32510/plushie_flutter/main/assets/app_icon.png',
        description: 'iOS app that turns photos into plushie-style images using OpenAI gpt-image-1 (edits API). Shipped on the App Store; automation with Xcode Cloud and GitHub Actions alongside a clean BLoC-based Flutter codebase.',
        techStack: [
          'Flutter',
          'Dart',
          'Bloc',
